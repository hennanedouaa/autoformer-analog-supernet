...
# LayerNormSuper
#
# This implementation is directly taken from the official AutoFormer repository:
# https://github.com/microsoft/Cream/tree/main/AutoFormer
#
# Original paper:
# Chen, M., Peng, H., Fu, J., & Ling, H. (2021).
# AutoFormer: Searching Transformers for Visual Recognition.
# ICCV 2021.
#
# We reuse this module unchanged as part of the AutoFormer supernet
# infrastructure and integrate it within our analog multi-operator framework.
# ------------------------------------------------------------------------------
